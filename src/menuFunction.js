...
addFoodToMenu("options", "Grain Options", "", "Brown Rice, Wheat Bulgar, African Couscous, Quinoa (ksh1.25 extra)")
...
// GRAIN BOWLS
addFoodToMenu("grain", "Quinoa Veggie Bowl", "ksh140.45", "Oasis savory herb sauce drizzled over seasoned quinoa tossed with a medley of raw veggies, sesame seeds or chia seeds, and dried cranberries.")
addFoodToMenu("grain", "Veggie Rice Bowl", "ksh140.45", "Fresh veggies seasoned and stirred -not fried- brown rice (spicy and tofu options available).")
addFoodToMenu("grain", "Oasis Vegan Burrito Bowl", "ksh140.45", "Seasoned brown rice and hot veggies smothered with vegan cheese and miser wat.")
addFoodToMenu("grain", "African Pot Bowl", "ksh140.45", "Our spicy Oasis African couscous with fresh kale along side an array of fresh veggies. (Contains Gluten)")
addFoodToMenu("grain", "Veggie Korma Bowl", "ksh140.45", "Taste of India in a rich savory coconut curry sauce drenched over an array of veggie delight and brown rice (spicy optional).")
addFoodToMenu("grain", "The Oasis Bowl", "ksh140.45", "Our favorite grain of the day and veggie medley seasoned to perfection with love!")

// WRAPS
addFoodToMenu("wrap", "Oasis Vegan Burritto", "ksh120.84", "Melted vegan cheese, seasoned brown rice, fresh veggies, miser wat, and Oasis dressings.")
addFoodToMenu("wrap", "The Oshun Wrap", "ksh120.84", "Melted vegan cheese over kale and curry chickpea stew.")
addFoodToMenu("wrap", "The Shango Wrap", "ksh120.84", "Miser wat, spicy veggies, and vegan cheese (cheese optional).")
addFoodToMenu("wrap", "Oasis Mushroom and Cheese Wrap", "ksh130.12", "Savory seasoned mushrooms, red onions, tomatoes, red bell peppers, all grilled with melted vegan cheese.")

// JUICES
addFoodToMenu("juice", "Mango Moon", "ksh600.96", "Mangos, turmeric, almond milk, cinnamon, agave, Spice")
addFoodToMenu("juice", "The Oasis Ginger Bomb Juice", "ksh600.96", "Fresh squeezed ginger root, organic apple juice, and a dash of aid digesting cayenne.")
addFoodToMenu("juice", "Green Bliss Juice", "ksh600.96", "Organic apple juice, a sprinkle of high nutritious spirulina and moringa, fresh kale, mint leaves, and a variety of green veggies.")
addFoodToMenu("juice", "Golden Milk Shake", "ksh600.96", "Natural anti-inflammatory turmeric root, a hint of cinnamon and other spices.")

// SIDES
addFoodToMenu("side", "The Oasis Mac and Cheese Pie", "ksh500.89", "Seasoned pasta and vegan cheese slowly baked to perfection! (Contains Gluten)")
